...
import org.opensearch.knn.index.KNNCommonSettings;
...
public class IndexHyperParametersUtil {
    ...
    public static int getHNSWEFConstructionValue(@NonNull final Version indexVersion) {
        ...
        log.debug(
            ...
            indexVersion,
            KNNCommonSettings.INDEX_KNN_DEFAULT_ALGO_PARAM_EF_CONSTRUCTION
        );
        return KNNCommonSettings.INDEX_KNN_DEFAULT_ALGO_PARAM_EF_CONSTRUCTION;
    }
    ...
    public static int getHNSWEFSearchValue(@NonNull final Version indexVersion) {
        ...
        log.debug(
            ...
            indexVersion,
            KNNCommonSettings.INDEX_KNN_DEFAULT_ALGO_PARAM_EF_SEARCH
        );
        return KNNCommonSettings.INDEX_KNN_DEFAULT_ALGO_PARAM_EF_SEARCH;
    }
